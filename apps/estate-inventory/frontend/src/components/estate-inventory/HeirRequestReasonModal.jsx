 ...
 * Portaled above room browse (family portal traps nested fixed overlays).
 */
const HeirRequestReasonModal = ({ open, itemName, onClose, onSubmit, busy }) => {
  ...
  const modal = (
    <div className="estate-inventory ei-modal-portal">
      <div className="ei-modal-backdrop ei-heir-stack-backdrop" role="presentation" onClick={onClose}>
        <div
