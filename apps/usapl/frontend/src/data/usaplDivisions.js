...
export const USAPL_DIVISIONS = [
  ...
  {
    id: 'denver-metro-cash',
    name: 'Denver Metro Area – Introductory Cash Session',
    shortName: 'Denver Metro Cash',
    night: 'Tuesday',
    format: 'Double play 8-ball & 10-ball',
    playStarts: '',
    lastWeek: '',
    ...
    signupOpen: true,
    sortOrder: 15,
    reportHeading: 'Team & individual stats',
    reportBlurb: '8-ball and 10-ball have separate standings and cash payouts. No playoffs; final standings determine payouts.',
    notes: [
      'Tuesdays at 7 PM. Home-and-away / multi-venue.',
      '$10 per player per format (8-ball and 10-ball each). No annual membership fee.',
      '8-ball and 10-ball have separate standings and cash payouts. No playoffs; final standings determine payouts.',
      'Finish Strong Cash Drawing for teams that finish the session but do not cash in either format.',
      'Teams that complete the Fall session with dues paid within 48 hours of each match can earn a $100 credit toward the January 2027 session.',
      'January 2027 returns to the normal Vegas-qualifying structure.',
    ],
  },
  {
    id: 'wed-13861-13061',
