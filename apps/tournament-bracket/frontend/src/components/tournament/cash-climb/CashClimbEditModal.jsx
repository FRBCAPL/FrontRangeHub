              ...
              {moneyLocked ? (
                ...
                <p className="players-count">
                  {prizePool
                    ...
                    : 'Unused KOH is the championship. Unused RR leftover for 3rd is paid when they sit. Last two may chop remaining leftover. Champion protection never takes 3rd leftover.'}
                </p>
              ) : (
                <p className="players-count">
